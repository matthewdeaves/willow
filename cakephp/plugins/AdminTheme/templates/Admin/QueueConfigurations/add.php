 ...
 */
?>
<?php $this->assign('title', __('Add Queue Configuration')); ?>

<header class="py-3 mb-3 border-bottom">
    <div class="container-fluid d-flex align-items-center">
        <div class="d-flex align-items-center me-auto">
            <h1 class="h3 mb-0"><?= __('Add Queue Configuration') ?></h1>
        </div>
                                ...
                                <div class="col-md-3">
                                    <div class="mb-3">
                                        <?= $this->Form->control('priority', [
                                            ...
                                            'default' => 5,
                                            'id' => 'priorityRange',
                                            'label' => __('Priority') . ' <span id="priorityValue">5</span>'
                                        ]) ?>
