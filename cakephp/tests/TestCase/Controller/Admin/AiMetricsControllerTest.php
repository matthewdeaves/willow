...
class AiMetricsControllerTest extends AppControllerTestCase
{
    ...
    public function testDashboardRendersCorrectly(): void
    {
        ...
        $this->assertResponseContains('rate-limit-value');
    ...
    public function testDashboardRequiresAuth(): void
    {
        ...
        $this->get('/admin/ai-metrics/dashboard');
        // The system redirects to the localized home page with login prompt
        // This is the actual behavior based on the routing and auth middleware
        $this->assertResponseCode(302);
        $this->assertRedirectContains('/en'); // Redirects to localized homepage
    }
    ...
    public function testRealtimeDataRequiresAuth(): void
    {
        ...
        // The actual behavior is a 302 redirect, not 401
        // This matches the middleware behavior for unauthenticated requests
        $this->assertResponseCode(302);
    }
