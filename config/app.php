...
return [
    ...
    'Cache' => [
         ...
         * data related to IP blocking. The cache files will be stored in the
         * specified path and will have a duration of 5 minutes.
         *
         * @var array $ip_blocker
         * @property string $className The class name of the cache engine, in this case, 'File'.
         * @property string $path The path where cache files should be stored, defined as CACHE . 'ip_blocker/'.
         * @property string $duration The duration for which the cache is valid, set to '+5 minutes'.
         */
        'ip_blocker' => [
            'className' => 'File',
            'path' => CACHE . 'ip_blocker/',
            'duration' => '+1 week',
        ],
        
        /**
         * Cache configuration for storing article data.
         *
         * This configuration uses the File cache engine to store cached data related to articles.
         * The cache files are stored in the 'articles' directory within the CACHE path.
         * Cached data will expire after one week.
         *
    ...
    'Error' => [
        ...
        'log' => true,
        'trace' => true,
        'ignoredDeprecationPaths' => ['vendor/cakephp/cakephp/src/I18n/I18n.php'],
    ],
