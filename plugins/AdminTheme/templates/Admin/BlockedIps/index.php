    ...
    <div class="container-fluid d-flex align-items-center blockedIps">
      <div class="d-flex align-items-center me-auto">
        <form class="d-flex-grow-1 me-3" role="search">
          <input id="blockedIpSearch" type="search" class="form-control" placeholder="<?= __('Search Blocked Ips...') ?>" aria-label="Search">
        </form>
      </div>
        ...
        <td>
            <div class="btn-group w-100 align-items-center justify-content-between flex-wrap">
                ...
                <ul class="dropdown-menu">
                    ...
                    <li>
                        <?= $this->Form->postLink(__('Delete'), ['action' => 'delete', $blockedIp->id], ['confirm' => __('Are you sure you want to delete # {0}?', $blockedIp->id), 'class' => 'dropdown-item text-danger']) ?>
                    </li>
                </ul>
                </div>
            </div>
