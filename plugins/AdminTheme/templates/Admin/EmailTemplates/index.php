    ...
    <div class="container-fluid d-flex align-items-center emailTemplates">
      <div class="d-flex align-items-center me-auto">
        <form class="d-flex-grow-1 me-3" role="search">
          <input id="emailTemplateSearch" type="search" class="form-control" placeholder="<?= __('Search Email Templates...') ?>" aria-label="Search">
        </form>
      </div>
        ...
        <td>
            <div class="btn-group w-100 align-items-center justify-content-between flex-wrap">
                ...
                <ul class="dropdown-menu">
                    ...
                    <li>
                        <?= $this->Form->postLink(__('Delete'), ['action' => 'delete', $emailTemplate->id], ['confirm' => __('Are you sure you want to delete # {0}?', $emailTemplate->id), 'class' => 'dropdown-item text-danger']) ?>
                    </li>
                </ul>
                </div>
            </div>
