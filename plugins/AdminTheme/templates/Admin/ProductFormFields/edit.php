 ...
 */
$this->assign('title', __('Edit Product Form Field'));
?>
<div class="container-fluid my-4">
    <div class="d-flex justify-content-between align-items-center mb-3">
        ...
        <div class="btn-group">
            ...
            <?= $this->Form->postLink(__('Delete'), ['action' => 'delete', $productFormField->id], ['class' => 'btn btn-outline-danger', 'confirm' => __('Are you sure you want to delete field "{0}"?', $productFormField->field_label ?? $productFormField->field_name)]) ?>
        </div>
    </div>
