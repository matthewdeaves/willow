                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            <?= $this->Form->control('profile', [
                                'type' => 'file',
                                'class' => 'form-control' . ($this->Form->isFieldError('profile') ? ' is-invalid' : ''),
                    ...
                    <?php if (!empty($user->profile)): ?>
                        <div class="row">
                            <div class="col-md-12 mb-3">
                                <?= $this->Html->image($user->profile . '_' . Configure::read('SiteSettings.ImageSizes.large'), 
                                    ['pathPrefix' => 'files/Users/profile/', 'alt' => 'Profile Picture', 'class' => 'img-fluid']) ?>
                            </div>
                        </div>
                    <?php endif; ?>
                    <div class="row">
