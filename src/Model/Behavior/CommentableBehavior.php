...
class CommentableBehavior extends Behavior
{
     ...
     *
     * @param string|int $entityId The ID of the entity to which the comment is related.
     * @param string|int $userId The ID of the user who made the comment.
     * @param string $content The content of the comment.
     * @return \Cake\Datasource\EntityInterface|false The saved comment entity or false on failure.
     */
    public function addComment(int|string $entityId, int|string $userId, string $content): EntityInterface|false
    {
        $commentsTable = $this->_table->getAssociation($this->getConfig('commentsTable'))->getTarget();
     ...
     *
     * @param string|int $entityId The ID of the entity for which to retrieve comments.
     ...
     */
    public function getComments(int|string $entityId, array $options = []): ResultSet
    {
        $commentsTable = $this->_table->getAssociation($this->getConfig('commentsTable'))->getTarget();
