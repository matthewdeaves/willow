...
class QueueableImageBehavior extends Behavior
{
     ...
     *
     * This method is triggered after an entity is successfully saved in the database. It performs the following actions:
     ...
     * 3) Sends the constructed message to a RabbitMQ queue named 'image_uploads'. This message is used to initiate the 
     *    creation of resized image versions via the src/Command/ResizeImageConsumerCommand.php.
     *
