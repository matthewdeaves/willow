 ...
 * @property \App\Model\Table\AdaptersTable&\Cake\ORM\Association\BelongsTo $ParentAdapters
 * @property \App\Model\Table\AdaptersTable&\Cake\ORM\Association\HasMany $ChildAdapters
...
class AdaptersTable extends Table
{
    ...
    public function initialize(array $config): void
    {
        ...
        $this->belongsTo('ParentAdapters', [
            'className' => 'Adapters',
            'foreignKey' => 'parent_id',
        ]);
        $this->hasMany('ChildAdapters', [
            'className' => 'Adapters',
            'foreignKey' => 'parent_id',
        ]);
...
// EDIT FOR RULES CHECKER ON ADAPTERS TABLE
//     /**
...
//         $rules->add($rules->existsIn(['parent_id'], 'ParentAdapters'), ['errorField' => 'parent_id']);
//         $rules->add($rules->existsIn(['user_id'], 'Users'), ['errorField' => 'user_id']);
