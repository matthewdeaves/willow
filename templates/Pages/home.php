            ...
            <div class="content">
                ...
                <div class="row">
                    ...
                    <div class="column">
                        ...
                        <?php $settings = Cache::getConfig('default'); ?>
                        <?php if (!empty($settings)) : ?>
                            <li class="bullet success">The default cache is configured. To change the config edit config/app.php</li>
                        <?php else : ?>
                            <li class="bullet problem">Your default cache is NOT configured. Please check the settings in config/app.php</li>
                        <?php endif; ?>
                        </ul>
                    </div>
                </div>
